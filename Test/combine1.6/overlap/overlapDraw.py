...
#----- Draw Literals Original -----#
# Original drawing function of literals
# node stands for a node object
...
# node stands for a node object
# zoomRatio stands for the zoom ratio of the draw literals
...
# node1 and node2 stand for the nodes which this edge connect
...
# center stands for the circle center from which the Arc is drawn
# radius stands for the circle radius from which the Arc is drawn
# rotateAngle stands for the circle radius from which the Arc is drawn
# axis stands for the axis where the Arc is drawn
...
# center stands for the circle center from which the Arc and rectangle combination is drawn
# radius stands for the circle radius from which the Arc is drawn
# rotateAngle stands for the circle radius from which the Arc is drawn
# node stands for a node object
# axis stands for the axis where the Arc is drawn
# zoomRatio stands for the zoom ratio of the literals to be drawn
