...
graphDemo = Graph()
graphDemo.readInput("sample_input2.txt", 1) # 2 represents pattern 2, NEED aumatic checking!!!
calOverlapLayout(graphDemo, 1) # 2 represents pattern 2, NEED aumatic checking!!!
...
pattern1Draw(graphDemo, ax1) # 2 represents pattern 2, NEED aumatic checking!!!
