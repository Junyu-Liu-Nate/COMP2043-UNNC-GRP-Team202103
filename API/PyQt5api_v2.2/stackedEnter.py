...
class ShowResult(QWidget):
    ...
    def initUI(self):
        ...
        ###############################################################################################################
        #使用QToolButton来使用ToolButtonTextUnderIcon
        btnSD = QToolButton()
        btnSD.setText("Show DIFF")
        #btnSD.setStyleSheet("QPushButton{background-image: url(diff.png)}")
        pixDiff = QPixmap()
        pixDiff.load('diff.png')
        iDiff = QIcon(pixDiff)
        btnSD.setIcon(iDiff)
        #btnSD.setStyle(Qt.ToolButtonTextUnderIcon)
        btnSD.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
        btnSD.setMinimumHeight(80)
        layoutBtn.addWidget(btnSD)
        ###############################################################################################################
        btnAS = QToolButton()
        btnAS.setText("Alter Style")
        pixAlter = QPixmap()
        pixAlter.load('alter.png')
        iAlter = QIcon(pixAlter)
        btnAS.setIcon(iAlter)
        btnAS.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
        btnAS.setMinimumHeight(80)
        layoutBtn.addWidget(btnAS)
        ##############################
        btnSR = QToolButton()
        btnSR.setText("Show Result")
        pixResult = QPixmap()
        pixResult.load('result.png')
        iResult = QIcon(pixResult)
        btnSR.setIcon(iResult)
        btnSR.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
        btnSR.setMinimumHeight(80)
        layoutBtn.addWidget(btnSR)
        ##############################
        btnFB = QToolButton()
        btnFB.setText("Show Result")
        pixFeedback = QPixmap()
        pixFeedback.load('feedback.png')
        iFeedback = QIcon(pixFeedback)
        btnFB.setIcon(iFeedback)
        btnFB.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
        btnFB.setMinimumHeight(80)
        layoutBtn.addWidget(btnFB)
        ##############################
        btnEP = QToolButton()
        btnEP.setText("Export")
        pixDownload = QPixmap()
        pixDownload.load('result.png')
        iDownload = QIcon(pixDownload)
        btnEP.setIcon(iDownload)
        btnEP.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
        ...
        pixHome = QPixmap()
        pixHome.load('home.png')
        iHome = QIcon(pixHome)
        btnRE.setIcon(iHome)
        btnRE.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
        btnRE.setMinimumHeight(80)
        layoutBtn.addWidget(btnRE)
        ...
        btnRE.clicked.connect(self.click_btnRE)
...
if __name__ == "__main__":
    ...
    showResult.sign_toEnter.connect(enter.method_handle_sign)
